...
public:
    ...
    Result calculate(const ruckig::InputParameter<DOFs>& input, double delta_time) {
        ...
        for (size_t dof = 0; dof < DOFs; ++dof) {
            Block block;
            PositionStep1 step1 {p0[dof], v0[dof], a0[dof], pf[dof], vf[dof], af[dof], input.max_velocity[dof], -input.max_velocity[dof], input.max_acceleration[dof], -input.max_acceleration[dof], input.max_jerk[dof]};
